class DetailPhoneModel {
  String? code;
  String? message;
  Result? result;

  DetailPhoneModel({this.code, this.message, this.result});

  DetailPhoneModel.fromJson(Map<String, dynamic> json) {
    code = json['code'];
...
class Options {
  ...
  Options({this.label, this.selected, this.sku, this.quantity, this.url});
